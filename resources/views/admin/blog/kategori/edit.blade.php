...
<div class="modal fade" id="editkategori" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="col-lg-12" action="{{ route('kategori.update' ) }}" method="post">
                @csrf
                <div class="mb-3">
                    <label for="kategoriname" class="form-label fw-bold">Nama Kategori</label>
                    <input type="text" class="form-control" id="kategoriname" name="name" required>
