                ...
                <div class="box-body table-responsive">
                    <table id="category-table" class="table table-light table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="center" scope="row">{{ $tag->count() * ($tag->currentPage() - 1) + $loop->iteration }}</td>
                                <td align="left">{{ $row->name }}</td>
                                <td align="center">
                                    <div class="d-flex justify-content-evenly">
                                        <button type="button" class="btn btn-info edit" data-bs-toggle="modal" data-bs-target="#edittag" data-id="{{ $row->id }}"><i class="bi bi-pencil"></i></button>
